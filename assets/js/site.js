...
(function () {
  ...
  /* Kundendaten kommen aus window.SITE (wird von bauen.py aus kunde.json in die Seite geschrieben):
     - formEndpoint: leer = Demo-Modus, es wird nichts versendet (sichtbarer Hinweis nach dem Absenden)
     - hours: Wochentag (0 = Sonntag) -> Liste von [von, bis] in Minuten ab Mitternacht */
  const SITE = window.SITE || {};
  const FORM_ENDPOINT = SITE.formEndpoint || "";
  const HOURS = Object.assign({ 0: [], 1: [], 2: [], 3: [], 4: [], 5: [], 6: [] }, SITE.hours || {});
